var cm6 = (() => {
  ...
  function ElementContext(name2, parent) {
    ...
    for (let i = 0; i < name2.length; i++) this.hash += (this.hash << 4) + name2.charCodeAt(i) + (name2.charCodeAt(i) << 8);
  }
  ...
  function completeFromSchema(eltSpecs, attrSpecs) {
    ...
    return (cx) => {
      ...
      if (type == "openTag") {
        ...
        let options2 = closing2.concat(((parent === null || parent === void 0 ? void 0 : parent.children) || (context ? allElements : topElements)).map((e) => e.openCompletion));
        if (context && (parent === null || parent === void 0 ? void 0 : parent.text.length)) {
          let openTag = context.firstChild;
          if (openTag.to > cx.pos - 20 && !/\S/.test(cx.state.sliceDoc(openTag.to, cx.pos)))
            options2 = options2.concat(parent.text);
        }
        return {
          from,
          options: options2,
