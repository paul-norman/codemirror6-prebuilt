var cm6 = (() => {
  ...
  var descendant2 = /* @__PURE__ */ new ExternalTokenizer((input) => {
    if (space2.indexOf(input.peek(-1)) > -1) {
      let { next } = input;
  ...
  var unitToken2 = /* @__PURE__ */ new ExternalTokenizer((input) => {
    if (space2.indexOf(input.peek(-1)) < 0) {
      let { next } = input;
      if (next == 37) {
        input.advance();
  ...
  var spec_identifier2 = { __proto__: null, lang: 40, "nth-child": 40, "nth-last-child": 40, "nth-of-type": 40, "nth-last-of-type": 40, dir: 40, "host-context": 40, and: 244, or: 244, not: 74, only: 74, url: 86, "url-prefix": 86, domain: 86, regexp: 86, when: 117, selector: 142, from: 172, to: 174 };
  ...
  var parser2 = /* @__PURE__ */ LRParser.deserialize({
    ...
    specialized: [{ term: 116, get: (value) => spec_identifier2[value] || -1 }, { term: 23, get: (value) => spec_AtKeyword2[value] || -1 }],
    tokenPrec: 2180
  });
